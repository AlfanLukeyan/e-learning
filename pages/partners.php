...
<nav>
    ...
    <div class="nav-list">
      ...
      <?php else: ?>
        <?php
          ...
          $query_nav = $db->query($sql_nav); // Use $db instead of mysqli_query
          $user = $query_nav->fetch(PDO::FETCH_ASSOC); // Use fetch() with PDO::FETCH_ASSOC instead of fetch_assoc()
        ?>
  ...
  <main>
    ...
    <section class="catalog">
      <?php while ($partner = $query->fetch(PDO::FETCH_ASSOC)):  ?>
        <div class="card">
